...
if __name__ == "__main__":
    ...
    model = tf.keras.models.load_model('trained_models/' + model_name + '.h5', compile=False)
    ...
    for run_label in run_labels:
        ...
        # Run the complete benchmark workload repeatedly until the minimum measurement duration is reached.
        predictions_list = []
        repeat = 0
        ...
        while True:
            ...
            for image_data in test_data:
                ...
                # Add a batch dimension so that one image is processed at a time.
            ...
            if repeat == 1:
                predictions_list = current_predictions
        ...
        # Calculate the number of benchmark images processed during one benchmark workload.
    ...
    csv_path = os.path.join(
        results_folder,
        "CPU_image_classification_predictions.csv"
    )
    ...
    save_benchmark_results(
        ...
        results_filename="CPU_image_classification_benchmark_results.csv",
    ...
    print(os.path.join(
        results_folder,
        "CPU_image_classification_benchmark_results.csv"
    ))
    print("---------------------")
    ...
    print("CPU_image_classification_benchmark_results.csv")

    print()
    print("Prediction Results:")
    print("CPU_image_classification_predictions.csv")
