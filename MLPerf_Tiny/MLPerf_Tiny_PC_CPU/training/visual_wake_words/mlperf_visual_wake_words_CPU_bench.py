...
if __name__ == "__main__":
    ...
    for run_label in run_labels:
        ...
        benchmark_runs.append({
            ...
            "model": os.path.basename("trained_models/vww_96.h5"),
    ...
    total_time = final_run["inference_time"]
    ...
    csv_path = os.path.join(
        results_folder,
        "CPU_visual_wake_words_predictions.csv"
    )
    ...
    save_benchmark_results(
        ...
        results_filename="CPU_visual_wake_words_benchmark_results.csv",
    ...
    print(os.path.join(
        results_folder,
        "CPU_visual_wake_words_benchmark_results.csv"
    ))
    print("---------------------")
    ...
    print("CPU_visual_wake_words_benchmark_results.csv")

    print()
    print("Prediction Results:")
    print("CPU_visual_wake_words_predictions.csv")
