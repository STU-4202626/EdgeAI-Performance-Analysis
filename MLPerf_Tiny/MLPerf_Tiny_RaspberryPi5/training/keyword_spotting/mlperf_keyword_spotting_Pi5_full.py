...
if __name__ == "__main__":
    ...
    # This keeps data loading and input preparation outside the inference-time measurement.
    benchmark_inputs = []
    ...
    for run_label in run_labels:
        ...
        while True:
            ...
            for benchmark_input in benchmark_inputs:
                ...
                # Convert the SavedModel output logits into probabilities.
    ...
    csv_path = os.path.join(
        RESULTS_FOLDER,
        "Pi5_keyword_spotting_predictions_full.csv"
    )
    ...
    save_benchmark_results(
        ...
        results_filename="Pi5_keyword_spotting_benchmark_results_full.csv",
    ...
    print(os.path.join(
        RESULTS_FOLDER,
        "Pi5_keyword_spotting_benchmark_results_full.csv"
    ))
    print("---------------------")
    ...
    print("Pi5_keyword_spotting_benchmark_results_full.csv")

    print()
    print("Prediction Results:")
    print("Pi5_keyword_spotting_predictions_full.csv")
