...
if __name__ == "__main__":
    ...
    # Load the full TensorFlow/Keras MLPerf Tiny ResNet model.
    MODEL_PATH = "trained_models/pretrainedResnet.h5"
    ...
    for run_label in run_labels:
        ...
        while True:
            ...
            # Perform inference on each benchmark image individually using the full TensorFlow model.
            for input_data in benchmark_inputs:

                # Perform inference using the full TensorFlow model.
    ...
    csv_path = os.path.join(
        results_folder,
        "Pi5_image_classification_predictions_full.csv"
    )
    ...
    save_benchmark_results(
        ...
        results_filename="Pi5_image_classification_benchmark_results_full.csv",
    ...
    print(os.path.join(
        results_folder,
        "Pi5_image_classification_benchmark_results_full.csv"
    ))
    print("---------------------")
    ...
    print("Pi5_image_classification_benchmark_results_full.csv")

    print()
    print("Prediction Results:")
    print("Pi5_image_classification_predictions_full.csv")
