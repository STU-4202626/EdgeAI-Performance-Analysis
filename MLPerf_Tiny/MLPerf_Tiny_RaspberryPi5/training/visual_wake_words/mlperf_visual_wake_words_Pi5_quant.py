...
Performance evaluation of the quantized MLPerf Tiny Visual Wake Words
benchmark using the INT8 TensorFlow Lite model.
...
# Load the quantized MLPerf Tiny model
...
if __name__ == "__main__":
    ...
    # Retrieve the quantization parameters used to convert between floating-point values and the INT8 model.
    ...
    # This keeps image loading, resizing, normalisation and quantization outside the inference-time measurement.
    benchmark_inputs = []
    ...
    for run_label in run_labels:
        ...
        while True:
            ...
            for img_array in benchmark_inputs:
                ...
                # Dequantize the model output back to floating-point values.
                prediction = (
    ...
    csv_path = os.path.join(
        results_folder,
        "Pi5_visual_wake_words_predictions_quant.csv"
    )
    ...
    save_benchmark_results(
        ...
        results_filename="Pi5_visual_wake_words_benchmark_results_quant.csv",
    ...
    print(os.path.join(
        results_folder,
        "Pi5_visual_wake_words_benchmark_results_quant.csv"
    ))
    print("---------------------")
    ...
    print("Pi5_visual_wake_words_benchmark_results_quant.csv")

    print()
    print("Prediction Results:")
    print("Pi5_visual_wake_words_predictions_quant.csv")
