...
if __name__ == "__main__":
    ...
    # Load the full-precision Keras MobileNet V1 model.
    ...
    # Prepare all benchmark images before starting the timed benchmark runs.
    # This keeps image loading, resizing and normalisation outside the inference-time measurement.
    benchmark_inputs = []
    ...
    # Initialise the GPU before the visible warm-up section.
    with tf.device("/GPU:0"):
        _ = model.predict(benchmark_inputs[0], verbose=0)
    ...
    for run_label in run_labels:
        ...
        # Calculate benchmark throughput (images processed per second)
    ...
    csv_path = os.path.join(
        RESULTS_FOLDER,
        "GPU_visual_wake_words_predictions.csv"
    )
    ...
    save_benchmark_results(
        ...
        results_filename="GPU_visual_wake_words_benchmark_results.csv",
    ...
    print(os.path.join(
        RESULTS_FOLDER,
        "GPU_visual_wake_words_benchmark_results.csv"
    ))
    print("---------------------")
    ...
    print("GPU_visual_wake_words_benchmark_results.csv")

    print()
    print("Prediction Results:")
    print("GPU_visual_wake_words_predictions.csv")
