...
Benchmark Script
----------------
Evaluates the floating-point SavedModel Keyword Spotting model
...
if __name__ == '__main__':
    ...
    for run_label in run_labels:
        ...
        while True:
            ...
            for features, label in dataset:
                ...
                input_data = features.numpy().astype(np.float32)
    ...
    csv_path = os.path.join(
        RESULTS_FOLDER,
        "GPU_keyword_spotting_predictions.csv"
    )
    ...
    save_benchmark_results(
        ...
        results_filename="GPU_keyword_spotting_benchmark_results.csv",
    ...
    print(os.path.join(
        RESULTS_FOLDER,
        "GPU_keyword_spotting_benchmark_results.csv"
    ))
    print("---------------------")
    ...
    print("GPU_keyword_spotting_benchmark_results.csv")

    print()
    print("Prediction Results:")
    print("GPU_keyword_spotting_predictions.csv")
