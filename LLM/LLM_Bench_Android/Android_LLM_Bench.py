...
def run_prompt(prompt_text):
    ...
    # Remove Remove ANSI characters
    output = re.sub(r'\x1B[@-_][0-?]*[ -/]*[@-~]', '', output)

    # Remove spinning characters are coming from Ollama's streaming output
...
# Save results to CSV
with open("Android_LLM_bench.csv", "w", newline="", encoding="utf-8") as csvfile:
...
print("\nBenchmark completed.")
print("Results saved to Android_LLM_bench.csv\n")